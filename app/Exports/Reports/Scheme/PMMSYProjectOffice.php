...
class PMMSYProjectOffice implements FromCollection,WithHeadings,WithMapping
{
    ...
    {
        $b = Scheme::getdata('pmmsy_project_office');
    ...
    public function map($data): array
    {
        return [
            ...
            $data->details['individualbelongsut']??'',
            $data->details['fishermencoop']??'',
            $data->details['annualincome']??'',
            $data->details['quotation']??'',
            $data->details['consentletter']??'',
            $data->details['drivinglicensedata']??'',
            $data->details['productionexp']??'',
            $data->details['availedscheme']??'',
            $data->details['applicantssi']??'',
            $data->details['applicantfeasabilitycert']??'',
            $data->details['applicantmunicipal']??'',
            $data->details['applicantprojectreport']??'',
