...
class ProjectOffice implements FromCollection,WithHeadings,WithMapping
{
    ...
    {
        $datax=Scheme::getdata('pmmsy_project_office')->whereNotNull('meta->village')->orderBy('meta->village','asc');
