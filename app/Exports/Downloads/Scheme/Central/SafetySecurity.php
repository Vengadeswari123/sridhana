...
class SafetySecurity implements FromCollection,WithHeadings,WithMapping
{
    ...
    {
        $datax=Scheme::getdata('pmmsy_safety_and_security')->whereNotNull('meta->village')->orderBy('meta->village','asc');
