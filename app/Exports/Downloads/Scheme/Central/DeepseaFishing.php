...
class DeepseaFishing implements FromCollection,WithHeadings,WithMapping
{
    ...
    {
        $datax=Scheme::getdata('pmmsy_development_of_deep_sea_fishing')->whereNotNull('meta->village')->orderBy('meta->village','asc');
