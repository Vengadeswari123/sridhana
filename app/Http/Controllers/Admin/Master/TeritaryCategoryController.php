...
class TeritaryCategoryController extends Controller
{
    public $xdata = [
        'title' => 'Tertiary Category',
        'url' => '/admin/master/teritarycategory',
        'filename' => 'Admin.Master.TertiaryCategory',
        'modelname' => 'teritarycategory',
    ];
    ...
    {
        $data = Master::module($this->xdata['modelname'])->with('category','tercategory')->find($id);
        if ($data) {
