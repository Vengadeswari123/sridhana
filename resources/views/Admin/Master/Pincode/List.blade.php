            ...
            <form method="get">
                ...
                <table class="table mt-3">
                    ...
                    <tbody>
                        <tr>
                            <td>
                                <vue-inputtext type="text" name="state" id="state" value="{{ request()->get('state')??'' }}"  placeholder="State">
                                </vue-inputtext>
                            </td>
                                <td>
                                <vue-inputtext type="text" name="pincode" id="pincode" value="{{ request()->get('pincode')??'' }}"  placeholder="Pincode">
                                </vue-inputtext>
                                </td>
                                <td>
                                <vue-inputtext type="text" name="country" id="country" value="{{ request()->get('country')??'' }}"  placeholder="Country">
                                </vue-inputtext>
                                </td>
                                <td>
                                <vue-inputtext type="text" name="cost" id="cost" value="{{ request()->get('cost')??'' }}"  placeholder="Cost">
                                </vue-inputtext>

                            <td>
                                <vue-inputvselect name="status" :options="[{'id':1,'name':'Active'},{'id':0,'name':'Disabled'}]" :value="{{ request()->get('status')??-1 }}" placeholder="Status"></vue-inputvselect>
                            </td>
