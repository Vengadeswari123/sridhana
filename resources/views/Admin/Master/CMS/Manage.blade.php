        ...
        <div class="card mt-4 p-3-e" style="border-radius: 15px">
            ...
            <form method="post" enctype="multipart/form-data" class="p-2"> @csrf
                <div class="row">
                    ...
                    <vue-inputtextarea type="text" class="col-12 col-sm-12 mt-2 col-md-6" key="description" name="description" id="description" error="{{ $errors->first('description')??'' }}" value="{{ old('description')??$data->data['description']??'' }}" label="Description" placeholder="Description">
                    </vue-inputtextarea>
