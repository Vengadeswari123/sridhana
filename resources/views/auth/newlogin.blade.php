        ...
        <div class="row m-0 h-100">
            <div class="col-lg-6 login-buttons">
                ...
                <div class="d-grid buttons">
                    ...
                    <a href="/newlogin" class="btn btn-outline-ecustom hovered mt-3 py-2" style="border-radius: 3px">New User</a>
            ...
            <div class="bg-eblue login-eforms col-lg-6">
                ...
                <div class="">
                    <form class="row g-2 pb-3 form-login-ecustom">
                         <div class="mt-2">
                            <label for="inputAddress2" class="form-label my-0"> Name </label>
                        ...
                        <div class="mt-2">
                            <label for="inputAddress2" class="form-label my-0"> Aaadhar No. </label>
                            <input type="text" class="bg-white form-control" id="inputAddress2">
                        </div>
                        <div class="mt-2">
